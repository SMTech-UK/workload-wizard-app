      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              By accessing and using WorkloadWizard, you accept and agree to be bound by these terms.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                ...
                <li>Data analysis and reporting for institutional purposes</li>
              </ul>
            </div>
            <Separator />
            <div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm">Provide accurate and complete information during registration</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-sm">Maintain the security of your password and account</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-sm">Notify us immediately of any unauthorised use</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            <div className="bg-muted/50 p-4 rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                All academic workload data is encrypted and stored securely in compliance 
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              ...
              of significant changes via email or through the service interface. Continued use 
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="space-y-2 text-sm">
              <p><strong>Email:</strong> support@workloadwizard.com</p>
              <p><strong>Support Portal:</strong> Available through your admin dashboard</p>
            </div>
          </CardContent>
        </Card>
        </div>
