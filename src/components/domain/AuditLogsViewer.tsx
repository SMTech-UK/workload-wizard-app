  ...
  const goToPage = useCallback(
    (page: number) => {
      if (page === 1) {
        ...
        console.warn(
          "Going back to previous pages not supported with cursor-based pagination",
        );
      } else {
        // For pages > currentPage, we need to load all intermediate pages
        console.warn(
          "Direct page navigation not supported with cursor-based pagination",
        );
      }
    },
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        console.warn(
                          "Jump to last page not supported with cursor-based pagination",
                        );
                      }}
                      disabled={!hasMore || isLoading}
                      className="h-8 px-3"
