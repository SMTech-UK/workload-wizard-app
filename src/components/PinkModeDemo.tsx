  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          This card demonstrates the pink theme when the pink-mode early access
          feature is enabled.
        </CardDescription>
      </CardHeader>
        ...
        {isPinkModeEnabled ? (
          <div className="p-4 bg-gradient-to-r from-pink-50 to-purple-50 rounded-lg border border-pink-200">
            ...
            <p className="text-sm text-pink-700">
              Pink mode is active! Notice how this card and the entire UI now
              has a pink theme.
            </p>
          </div>
        ) : (
          <div className="p-4 bg-muted rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              Pink mode is currently inactive. Enable the &quot;pink-mode&quot;
              early access feature to see the pink theme.
            </p>
